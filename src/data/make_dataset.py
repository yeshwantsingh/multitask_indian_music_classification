...
def get_dataset_info(base_path, dataset_nick_name):
    ...
    elif dataset_nick_name == 'semi_classical':
...
def get_semi_classical_label(file_path):
    ...
    label1 = int(tf.strings.split(input=parts[-3], sep='_')[1])  # Genre_id
    label2 = int(tf.strings.split(input=parts[-2], sep='_')[1])  # Artist_id
    label3 = int(tf.strings.split(input=parts[-2], sep='_')[2])  # Gender_id
    label4 = int(tf.strings.split(input=tf.strings.split(input=parts[-1],
                                                         sep='_')[1], sep='.')[0])  # No_of_artists
...
def get_folk_label(file_path):
    ...
    label1 = int(tf.strings.split(input=parts[-3], sep='_')[1])  # Genre_id
    label2 = int(tf.strings.split(input=parts[-2], sep='_')[1])  # State_id
    label3 = int(tf.strings.split(input=parts[-2], sep='_')[2])  # Artist_id
    label4 = int(tf.strings.split(input=parts[-2], sep='_')[3])  # Gender_id
    label5 = int(tf.strings.split(input=tf.strings.split(input=parts[-1],
                                                         sep='_')[1], sep='.')[0])  # No_of_artists
    return label1, label2, label3, label4, label5
